...
function App() {
  ...
  return (
    currentPage === 'Welcome' ? (
      <Welcome setCurrentPage={(value) => setCurrentPage(value)} saveTurkId={(value) => setUserData({...userData, "turkId": value})}/>
    ) : currentPage === 'Rules' ? (
      <Rules setCurrentPage={(value) => setCurrentPage(value)}/>
    ) : currentPage === 'Examples' ? (
      <Examples setCurrentPage={(value) => setCurrentPage(value)}/>
    ) : currentPage === 'PreTest' ? (
      <PreTest setCurrentPage={(value) => setCurrentPage(value)}/>
    ) : currentPage === 'Test' ? (
      <Test setCurrentPage={(value) => setCurrentPage(value)} saveData={(data) => setUserData({...userData, "test": data})}/>
